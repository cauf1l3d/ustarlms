...
$hasreporting=\local_ustar\org::reporting_configured();
$treehtml=$hasreporting?local_ustar_render_org_tree(\local_ustar\org::company_tree()):'';
$data=[
 ...
 'qualified'=>$qualification['qualified'],'withgaps'=>$qualification['withgaps'],'expired'=>$qualification['expired'],'qualcoverage'=>$qualification['coverage'],'topgaps'=>$qualification['topgaps'],'hastopgaps'=>$qualification['hastopgaps'],'orgtreehtml'=>$treehtml,'hasreporting'=>$hasreporting,
];
