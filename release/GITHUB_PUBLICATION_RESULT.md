...
| Verified documentation commit | `cb402954cd433e66fafbe6c925c713f0e38fc227` |
| Push mode | New branch, non-force |
| Production release | Not authorized / not performed |

Remote verification after the documentation push, before this record-only annotation:

```text
refs/heads/main                       5443bf5ab2c000a0fc019d3b0b30dcff0a60a7ff
refs/heads/ustar-final-audit-release  cb402954cd433e66fafbe6c925c713f0e38fc227
```
...
5. `cb40295` — GitHub publication result and refreshed bundle manifest.
