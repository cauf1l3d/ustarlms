> Обновление 24.09: [PR #14](https://github.com/cauf1l3d/ustarlms/pull/14) (`codex/ustar-complete-rc-20260923`) — черновой кандидат на базе `main`, включающий ещё не принятые изменения предыдущих PR. Все 60 требований учтены в [реестре приёмки](context/roadmap/RC_AUDIT_ACCEPTANCE_20260924.md). Moodle DB, браузерная приёмка и восстановление полного backup остаются открытыми. Указанные ниже SHA и проверки описывают историческую базу 19–20.09, а не состояние этого чернового кандидата.
