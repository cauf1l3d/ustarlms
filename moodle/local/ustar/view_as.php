...
$data=['positions'=>$positions,'hasactive'=>$active!=='','posturl'=>(new moodle_url('/local/ustar/view_as.php'))->out(false),'sesskey'=>sesskey(),'routetesterurl'=>(new moodle_url('/local/ustar/route_tester.php'))->out(false),'canroutetester'=>is_siteadmin()];
