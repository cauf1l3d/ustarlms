...
| USCOIN | B049–B053 | 7 ledger rows; Studio предлагает XP→USCOIN | Mastery и экономическая награда смешиваются | Разделить ledgers; conversion только при отдельной policy |
...
| `boards` | Тонкая видимость | Current умеет только same-department | Ввести audience policy и editor/owner rights |
