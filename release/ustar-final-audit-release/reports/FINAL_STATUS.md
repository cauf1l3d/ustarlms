...
- Native HTML5 drag remains unproven through the in-app browser driver: two coordinate-driven attempts produced no move. Keyboard/context move is authenticated-browser PASS, while drag endpoint, audit, stale-write and cycle behavior are covered by the 15/15 isolated service verifier. Production deployment is not authorised.
